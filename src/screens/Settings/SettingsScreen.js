...
import { useTheme, useUser } from '../../context/UserContext';
 ...
 * Includes theme toggle, default tone, LinkedIn connection, and support.
 */
const SettingsScreen = () => {
  ...
  const handleLinkedInConnect = () => {
    Alert.alert(
      'Connect LinkedIn',
      'This will allow Linquoral to post directly to your LinkedIn account.',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Connect', onPress: () => {
          // TODO: Implement LinkedIn OAuth
          Alert.alert('Coming Soon', 'LinkedIn integration will be available soon.');
        }},
      ]
    );
  };
   ...
   */
  const handleSupport = () => {
    Linking.openURL('mailto:support@linquoral.com?subject=Linquoral Support');
  };
   ...
   */
  const handlePrivacy = () => {
    Linking.openURL('https://linquoral.com/privacy');
  };
   ...
   */
  const handleTerms = () => {
    Linking.openURL('https://linquoral.com/terms');
  };
      ...
      >
        ...
        <View style={styles.settingsGroup}>
          <SettingItem
            ...
            subtitle="Enable direct posting"
